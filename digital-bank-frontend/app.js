...
//   toast("Login successful.", false, 1800);
...
//   const authButton = $("#mobileLogoutButton");
//   const authIcon = $("#mobileAuthIcon");
//   const authLabel = $("#mobileAuthLabel");

//   if (authButton) {
//     authButton.setAttribute("aria-label", S.token ? "Logout" : "Sign in");
//   }
//   if (authIcon) authIcon.textContent = S.token ? "↪" : "→";
//   if (authLabel) authLabel.textContent = S.token ? "Logout" : "Sign in";
...
// function startTransferConfirmation(form) {
...
//   $("#confirmRecipient").textContent = data.to;
//   $("#confirmAccount").textContent = data.from;
...
//     if ($("#transferResult")) {
//       $("#transferResult").innerHTML = `<b>${esc(d.message || "Transfer successful")}</b><br>Reference: ${esc(d.data?.transaction?.reference || d.data?.nibss?.transactionId || "—")}`;
//     }
